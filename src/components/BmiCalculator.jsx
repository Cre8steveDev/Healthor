...
const BmiCalculator = () => {
  ...
  const [bmiView, setBMIView] = useState(false);

  const bmiStr = bmiView ? "CLOSE BMI CALCULATOR" : "VIEW BMI CALCULATOR";

  return (
    <div className="bmi-container">
      <h2 onClick={() => setBMIView(!bmiView)}>{bmiStr}</h2>
      {bmiView && (
        <>
            ...
            <div className="age-box shared">
              ...
              <div className="adjust-value">
                <div
                  ...
                  onClick={() =>
                    setBMIData({ ...BMIData, age: BMIData.age - 1 })
                  }
                >
                  -
                </div>
